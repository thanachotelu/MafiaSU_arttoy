...
values
    ...
    'https://scontent.fbkk17-1.fna.fbcdn.net/v/t51.75761-15/465765411_17983926005716691_3256785103269771383_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=127cfc&_nc_eui2=AeEOk0MdO8tHgv9IurCngicfLMzm9rpv_fMszOb2um_982ps2E7WSrohEu2YEaDqbBSktCk3YwePn-p0IPfqHhmQ&_nc_ohc=tX97LZb99UcQ7kNvgGuWCvd&_nc_zt=23&_nc_ht=scontent.fbkk17-1.fna&_nc_gid=Av1XgpGIbSFl7U6_MQ9dTb_&oh=00_AYAcVnzis2674WDbXBs4ICR--wkZrYJLCzHuneyma2Aa7A&oe=67323144',
    ...
    ((select product_id from products where name = 'SKULLPANDA Tell Me What You Want Series Figures' limit 1),
    ...
    ((select product_id from products where name = 'CRYBABY Crying Again Series-Card Holder Blind Box' limit 1),

...
import Sorting from '../components/Sorting';  // นำเข้า Sorting Component
...
const SearchResults = () => {
  ...
  return (
    <div>
      ...
      <div className="sort-container-center">
        <h2 className="text-center mb-4">Search results "{searchQuery}"</h2>

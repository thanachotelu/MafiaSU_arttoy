...
const Popmart = () => {
    ...
    const [selectedShops, setSelectedShops] = useState(["POP MART"]); // Default selected shop
        ...
        <div>
            ...
            <div className="advertisement-banner" style={{
                ...
                <div style={{
                    ...
                    <p>🚨 Welcome to POP MART! 🚨 Check out our latest art toys and limited edition figures! 🛍️</p>
                </div>
            </div>
            ...
            <div style={{
                ...
                <img
                    src="https://scontent.fbkk12-5.fna.fbcdn.net/v/t39.30808-6/434672166_122119495490242717_114891837650287260_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=2285d6&_nc_ohc=K-2MFg6mKG4Q7kNvgGrDjiG&_nc_zt=23&_nc_ht=scontent.fbkk12-5.fna&_nc_gid=AfXNRErrRK4RCKVKgS9b4sO&oh=00_AYDs_gNhoCyP158A6lXYJBtc_9JfzpBevUqy0D6uOGpeaA&oe=6737B9A0"
                    alt="Advertisement"
                    style={{
                        width: '100%',
                        height: 'auto',
            ...
            <div style={{
                ...
                <img
                    src="https://down-bs-th.img.susercontent.com/cn-11134210-7ras8-m2ay1opz34ou06.webp"
                    alt="Advertisement"
                    style={{
                ...
                <img
                    src="https://down-bs-th.img.susercontent.com/cn-11134210-7ras8-m2buxez9p01q79.webp"
                    alt="Advertisement"
                    style={{
                        width: '50%',
                        maxWidth: '1200px', // จำกัดขนาดความกว้างสูงสุด

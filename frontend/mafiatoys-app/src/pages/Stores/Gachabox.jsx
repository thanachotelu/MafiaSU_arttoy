...
const Gachabox = () => {
  ...
  const [selectedShops, setSelectedShops] = useState(["GACHABOX"]); // Default selected shop
    ...
    <div>
      ...
      <div className="advertisement-banner" style={{
        ...
        <div style={{
          ...
          <p>🚨 Welcome to GACHABOX! 🚨 Check out our latest art toys and limited edition figures! 🛍️</p>
        </div>
      </div>
